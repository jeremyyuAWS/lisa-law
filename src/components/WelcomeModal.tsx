    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex border-b border-gray-200 overflow-x-auto">
          ...
          <button
            className={`px-6 py-2 font-medium text-sm whitespace-nowrap min-w-max ${currentTab === 'analytics' ? 'text-indigo-600 border-b-2 border-indigo-600 mb-[-1px] relative z-10' : 'text-gray-600 hover:text-gray-900'}`}
            onClick={() => setCurrentTab('analytics')}
          >
            Analytics
          </button>
          <button
            className={`px-6 py-2 font-medium text-sm whitespace-nowrap min-w-max ${currentTab === 'comparison' ? 'text-indigo-600 border-b-2 border-indigo-600 mb-[-1px] relative z-10' : 'text-gray-600 hover:text-gray-900'}`}
